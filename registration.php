...
extract($_REQUEST);
$register = $user->reg_user($fullname, $uname,$upass, $uemail, $urole);
if ($register) {
// Inregistrare Success
echo 'Registration successful <a href="login.php">Click here</a> pt login';
} else {
// Inregistrare esec
echo 'Inregistrare esec. Email sau Username exista';
}
}?>
...
<tr>
<th>Rol:</th>
<td><select id='urole' name='urole' required>
